  ...
  return (
    <div className="rp-wrap">
      ...
      <div className="rp-side">
        ...
        {/* Main content – vertically centred via CSS margin:auto */}
        <div className="rp-side-mid">
          ...
          <p className="">
            Upload, share, and manage academic files with enterprise-grade
            protection built in.
          </p>
        </div>
        ...
        <div className="rp-features">
          {[
            ...
            },
            {
              ...
              text: (
                <>
                  <strong>ClamAV</strong> malware scanning
                </>
              ),
            },
            {
              ...
              text: (
                <>
                  <strong>Audit logs</strong> for every action
                </>
              ),
            },
          ].map((f, i) => (
        ...
        <div className="rp-form-box">
          ...
          <form onSubmit={submit} noValidate>
            ...
            <div className="rp-field">
              ...
              {errors.email && (
                <div className="rp-field-err">{errors.email}</div>
              )}
            </div>
                  ...
                  <div className="rp-strength-bar">
                    {[0, 1, 2, 3].map((i) => (
                      <div
                        ...
                        style={{
                          background:
                            i < strength ? COLORS[strength - 1] : undefined,
                        }}
                      />
                    ))}
                  </div>
          ...
          <p className="rp-switch">
            ...
            <span className="rp-link" onClick={onSwitch}>
              Sign in →
            </span>
          </p>
        </div>
