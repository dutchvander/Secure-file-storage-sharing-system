        ...
        <div className="lp-form-box">
          ...
          {alert && (
            <div className={`lp-alert ${alert.type}`}>
              {alert.type === "error" ? <AlertIcon /> : <CheckCircleIcon />}
              <span>{alert.msg}</span>
            </div>
          )}
          ...
          <form onSubmit={submit} noValidate>
            <div className="lp-field">
              ...
              <div className="lp-field-wrap">
                <input className={`lp-input${errors.email ? " has-error" : ""}`} type="email"
                  placeholder="you@university.edu" value={form.email} onChange={set("email")} autoComplete="email" />
            ...
            <div className="lp-field">
              ...
              <div className="lp-field-wrap">
                <input className={`lp-input${errors.password ? " has-error" : ""}`}
